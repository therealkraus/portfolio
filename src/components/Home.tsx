  ...
  return (
    <>
      <section id="home" className="max-w-screen-xl pl-28 pt-28">
        ...
        <a
          href="#contact-me"
          className="inline-block text-2xl  bg-transparent text-secondary font-medium px-12 py-5 mt-10 border-secondary border-2 hover:bg-secondary dark:hover:text-background hover:text-white rounded-lg"
        >
          CONTACT ME
        </a>
      </section>
